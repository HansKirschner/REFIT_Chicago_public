...
EndPOints_Session1           = nan(length(VPN),1);
...
for a = 1:size(VPN,1) %loop over participants and extract relevant info
    ...
    EndPOints_Session1(a) = rd.Bonus_sum(end);
...
ert
%save('Data/all_behavior_Session1','D');
%save('Data/all_EndPOints_Session1','EndPOints_Session1');

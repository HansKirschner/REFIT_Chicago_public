...
loadpath = 'rawData_DDP_Reversal_Learning_Task/_SubFolder/DrugG/';
...
for a = 1:size(VPN,1) %loop over participants and extract relevant info
    ...
    EndPOints_DS(a) = rd.Bonus_sum(end);

end


ert
%save('Data/all_behavior_MA','D');
%save('Data/all_EndPOints_MA','EndPOints_DS');

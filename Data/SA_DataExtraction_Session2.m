...
EndPOints_Session2           = nan(length(VPN),1);
...
for a = 1:size(VPN,1) %loop over participants and extract relevant info
    ...
    EndPOints_Session2(a) = rd.Bonus_sum(end);
...
ert
%save('Data/all_behavior_Session2','D');
%save('Data/all_EndPOints_Session2','EndPOints_Session2');

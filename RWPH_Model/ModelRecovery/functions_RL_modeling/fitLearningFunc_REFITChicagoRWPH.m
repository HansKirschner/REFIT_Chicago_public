...
[output.negLogLike, output.allLR, output.expP,output.ChoiceProb, new_input, output.logLike_woPrior, output.RPE]=learningFunc_REFITChicagoRWPH(estimates, input);

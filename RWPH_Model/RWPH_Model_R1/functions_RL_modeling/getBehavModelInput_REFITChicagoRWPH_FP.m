function input = getBehavModelInput_REFITChicagoRWPH_FP(datastruct,paramsToFit,paramValue,index)
%keyboard
...
input.CorrChoice = datastruct.CorrectResp;
...
input.learningMat(:,1) = ones(length(datastruct.event),1);
input.learningMat(:,2) = input.feedConfir;

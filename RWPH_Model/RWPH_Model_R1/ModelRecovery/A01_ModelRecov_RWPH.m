...
for tt = 1:length(allParamSets)
    ...
    for s = 1:length(dstruct)
        ...
        ModelE.(['Model_' paramStr '_Data'])(s).Compare_BIC  = mean(ModelComparision_CompareBIC);
        ModelE.(['Model_' paramStr '_Data'])(s).Compare_LL   = mean(ModelComparision_LL);
    end
end

save("data/ModelRecovery.mat","ModelE")
ert 

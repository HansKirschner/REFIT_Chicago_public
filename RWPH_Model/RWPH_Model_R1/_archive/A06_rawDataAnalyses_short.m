...
RawInfoPLSession = struct;

RawInfoPLSession.RS_earlyLearning_HighProb  = RS_earlyLearing_HighProb;
RawInfoPLSession.RS_lateLearning_HighProb   = RS_lateLearning_HighProb;

RawInfoPLSession.RS_earlyLearning_LowProb  = RS_earlyLearing_LowProb;
RawInfoPLSession.RS_lateLearning_LowProb   = RS_lateLearning_LowProb;

RawInfoPLSession.RS_Err_earlyLearning_HighProb  = RS_Err_earlyLearing_HighProb;
RawInfoPLSession.RS_Err_lateLearning_HighProb   = RS_Err_lateLearning_HighProb;

RawInfoPLSession.RS_Err_earlyLearning_LowProb  = RS_Err_earlyLearing_LowProb;
RawInfoPLSession.RS_Err_lateLearning_LowProb   = RS_Err_lateLearning_LowProb;

RawInfoPLSession.CorrChoice_earlyLearning_HighProb  = CorrChoice_earlyLearing_HighProb;
RawInfoPLSession.CorrChoice_lateLearning_HighProb   = CorrChoice_lateLearning_HighProb;

RawInfoPLSession.CorrChoice_earlyLearning_LowProb  = CorrChoice_earlyLearing_LowProb;
RawInfoPLSession.CorrChoice_lateLearning_LowProb   = CorrChoice_lateLearning_LowProb;

RawInfoPLSession.SD_LR_earlyLearning_all  = SD_LR_earlyLearing_all;
RawInfoPLSession.SD_LR_lateLearning_all   = SD_LR_lateLearning_all;

RawInfoPLSession.SD_LR_earlyLearning_HighProb  = SD_LR_earlyLearing_HighProb;
RawInfoPLSession.SD_LR_lateLearning_HighProb   = SD_LR_lateLearning_HighProb;

RawInfoPLSession.SD_LR_earlyLearning_LowProb  = SD_LR_earlyLearing_LowProb;
RawInfoPLSession.SD_LR_lateLearning_LowProb   = SD_LR_lateLearning_LowProb;


RawInfoPLSession.AccAfterMisleadingFB_earlyLearing_LowProb   = AccAfterMisleadingFB_earlyLearing_LowProb;
RawInfoPLSession.AccAfterMisleadingFB_lateLearning_LowProb   = AccAfterMisleadingFB_lateLearning_LowProb;
RawInfoPLSession.AccAfterMisleadingFB_lateLearning_HighProb  = AccAfterMisleadingFB_lateLearning_HighProb;


save("data/RawInfoPLSession_V2","RawInfoPLSession")
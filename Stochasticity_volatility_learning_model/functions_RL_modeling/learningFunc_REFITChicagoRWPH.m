function [negLogLike, allLR, expP, ChoiceProb, input, logLike_woPrior, RPE] = learningFunc_REFITChicagoRWPH(params, input)  %input comes from fmincon (initially start_point)
